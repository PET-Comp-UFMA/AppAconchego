...
export default function Pergunta111(){
        ...
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.titulo1}>11. Senti-me agitado</Text>
                </View>
                <View style={localStyles.container2}>
                    <BotaoEscolhaTeste
                        number = {0}
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P10')}/>
                    <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P12')} />
                </View>
        </SafeAreaView>
    )
}
