...
export default function Pergunta110(){
    ...
    return(
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View>
                    <Text style={GlobalStyles.titulo1}>Senti que não tinha nada a desejar</Text>
                </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P9')}/>
                <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P11')}/>
            </View>
        </SafeAreaView>
    )
}
