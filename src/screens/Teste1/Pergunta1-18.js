...
export default function Pergunta118(){
        ...
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.titulo1}>18. Senti que estava um pouco emotivo/sensível demais</Text>
                </View>
                <View style={localStyles.container2}>
                    <BotaoEscolhaTeste
                        number = {0}
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P17')} />
                    <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P19')}/>
                </View>
        </SafeAreaView>
    )
}
