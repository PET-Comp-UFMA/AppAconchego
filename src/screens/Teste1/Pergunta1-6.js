        ...
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.titulo1}>6. Tive tendência a reagir de forma exagerada às situações</Text>
                </View>
                <View style={localStyles.container2}>
                    <BotaoEscolhaTeste
                        number = {0}
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P5')} />
                    <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P7')} />
                </View>
        </SafeAreaView>
    )
}
