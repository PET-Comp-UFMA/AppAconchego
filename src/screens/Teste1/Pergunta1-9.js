        ...
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.titulo1}>9. Preocupei-me com situações em que eu pudesse entrar em pânico e parecesse ridículo</Text>
                </View>
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P8')} />
                    <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P10')} />
                </View>
        </SafeAreaView>
    )
}
