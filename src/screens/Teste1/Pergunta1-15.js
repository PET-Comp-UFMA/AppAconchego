...
export default function Pergunta115(){
        ...
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.titulo1}>15. Senti que ia entrar em pânico</Text>
                </View>
                <View style={localStyles.container2}>
                    <BotaoEscolhaTeste
                        number = {0}
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P14')} />
                    <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P16')} />
                </View>
        </SafeAreaView>
    )
}
