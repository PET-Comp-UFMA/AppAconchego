...
export default function Pergunta117(){
        ...
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.titulo1}>17. Senti que não tinha valor como pessoa</Text>
                </View>
                <View style={localStyles.container2}>
                    <BotaoEscolhaTeste
                        number = {0}
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P16')} />
                    <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste1P18')} />
                </View>
        </SafeAreaView>
    )
}
