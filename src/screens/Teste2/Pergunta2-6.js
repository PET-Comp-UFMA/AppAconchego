...
export default function Pergunta26(){
    ...
    return(
        <SafeAreaView style={localStyles.container}>
            <View>
                <Text style={GlobalStyles.titulo1}>Tem má disgestão?</Text>
            </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                ...
                <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste2P7')} />
            </View>
        </SafeAreaView>
    )
}
