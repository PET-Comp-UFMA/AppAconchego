...
export default function Pergunta37(){
    ...
    return(
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View>
                    <Text style={GlobalStyles.titulo1}>Quando está angustiado(a) com alguma problema, você costuma compartilhar essa preucupação com amigos, familiares ou até mesmo com um terapeuta?</Text>
                </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                ...
                <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste3R7')}/>
            </View>
        </SafeAreaView>
    )
}
