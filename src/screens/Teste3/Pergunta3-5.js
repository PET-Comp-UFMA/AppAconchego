...
export default function Pergunta35(){
    ...
    return(
        <SafeAreaView style={localStyles.container}>
            <ScrollView>
                <View>
                    <Text style={GlobalStyles.titulo1}>Você evita ao máximo a exposição solar, sempre que possível se mantém em locais fechados e cobertos?</Text>
                </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                ...
                <BotaoPeqProx title='Próximo' onPress={() => navigation.navigate('Teste3R5')}/>
            </View>
        </SafeAreaView>
    )
}
